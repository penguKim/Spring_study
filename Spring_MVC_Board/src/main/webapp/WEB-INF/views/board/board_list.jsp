...
<script type="text/javascript">
	...
	let maxPage = "";
	$(function() {
		// board_lis.jsp 페이지 로딩 시 게시물 목록 조회 수행을 위해 load_list() 함수 호출
		load_list();
...
// 			console.log("scrollTop : " + scrollTop + ", windowHeight : " + windowHeight + ", documentHeight : " + documentHeight);
			// scrollTop : 0, windowHeight : 619, documentHeight : 649 // 처음 높이
			// scrollTop : 29.66666603088379, windowHeight : 619, documentHeight : 649 // 마지막 높이
